  ...
  return (
    <div className="fixed inset-0 z-[60] bg-slate-50 flex flex-col items-center justify-between p-6 animate-fade-enter lg:hidden overflow-hidden">
      ...
      <div className="flex-1 flex flex-col items-center justify-center w-full max-w-md relative z-10 text-center">
        ...
        {/* Logo Section - Abstract Tech Health (Same as Desktop Hero) */}
        ...
        {/* Text Content - Updated Legal Safe Copy */}
        <div className="space-y-3 px-2">
            <div className="flex items-center justify-center gap-2 mb-2">
                ...
                <span className="bg-emerald-100 text-emerald-700 text-[10px] font-bold px-2 py-0.5 rounded-full border border-emerald-200 uppercase tracking-wide">Lima</span>
            </div>
            
            <h1 className="text-5xl font-bold text-slate-800 tracking-tighter leading-none">Doctoi</h1>
            
            <h2 className="text-xl font-medium text-slate-600">
                Tu brújula de salud <br/>
                <span className="text-transparent bg-clip-text bg-gradient-to-r from-blue-600 to-emerald-500 font-bold">Orientación Inteligente</span>
            </h2>
            
            <p className="text-sm text-slate-400 leading-relaxed max-w-[280px] mx-auto">
                Analiza tus síntomas con IA y encuentra farmacias y clínicas reales cerca de ti.
            </p>
        </div>
      ...
      <div className="w-full max-w-md space-y-4 relative z-10 mb-6">
        ...
        <div className="bg-slate-100/80 px-3 py-2 rounded-xl border border-slate-200/50 backdrop-blur-sm flex gap-2 items-start text-left">
            ...
            <p className="text-[10px] text-slate-500 leading-tight">
                <strong>Aviso:</strong> Herramienta informativa de orientación. No reemplaza una consulta médica profesional.
            </p>
        </div>
